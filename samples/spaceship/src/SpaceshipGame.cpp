...
void SpaceshipGame::initializeSpaceship()
{
    ...
    material = dynamic_cast<Model*>(_shipNode->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1", 0);
    ...
    // Part 1
    material = dynamic_cast<Model*>(_shipNode->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1", 1);
    ...
    initializeMaterial(material, true, true);
    // Part 2
    material = dynamic_cast<Model*>(_shipNode->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1", 2);
    ...
    material = dynamic_cast<Model*>(_propulsionNode->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1");
    material->getParameter("u_diffuseColor")->setValue(Vector4(0.8f, 0.8f, 0.8f, 1.0f));
    initializeMaterial(material, true, true);
...
void SpaceshipGame::initializeEnvironment()
{
    ...
    for (size_t i = 0, count = nodes.size(); i < count; ++i)
    {
        ...
        material = dynamic_cast<Model*>(pGround->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1");
        material->getParameter("u_diffuseColor")->setValue(Vector4(0.280584f, 0.5584863f, 0.6928f, 1.0f));
        initializeMaterial(material, true, true);
    }
    ...
    {
        Node* pRoof = nodes[i];
        material = dynamic_cast<Model*>(pRoof->getDrawable())->setMaterial("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "SPECULAR;DIRECTIONAL_LIGHT_COUNT=1");
        material->getParameter("u_diffuseColor")->setValue(Vector4(0.280584f, 0.5584863f, 0.6928f, 1.0f));
        initializeMaterial(material, true, true);
    }
