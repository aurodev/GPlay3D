...
void DrawStress::initialize()
{
    ...
    _materialColored = Material::create("res/coredata/shaders/colored.vert", "res/coredata/shaders/colored.frag", "VERTEX_COLOR");
    ...
    _materialTextured = Material::create("res/coredata/shaders/textured.vert", "res/coredata/shaders/textured.frag");
