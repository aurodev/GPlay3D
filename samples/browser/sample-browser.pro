...
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/game.config $$DESTDIR/sample-browser.config$$escape_expand(\n\t))
...
PWD_DEST_WIN ~= s,/,\\,g
win32: QMAKE_POST_LINK += $$quote(xcopy $$PWD_WIN\game.config $$PWD_DEST_WIN\sample-browser.config* /y /d$$escape_expand(\n\t))
