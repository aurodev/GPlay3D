...
void BillboardSample::loadGround()
{
	...
	Effect* effect = Effect::createFromFile("res/coredata/shaders/textured.vert", "res/coredata/shaders/textured.frag", "TEXTURE_REPEAT");    
...
void BillboardSample::loadBillboards()
{
    ...
    Effect* effect = Effect::createFromFile("res/coredata/shaders/textured.vert", "res/coredata/shaders/textured.frag", "TEXTURE_DISCARD_ALPHA");
