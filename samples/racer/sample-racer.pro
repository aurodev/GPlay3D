...
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/game.dds.config $$DESTDIR/sample-racer.config$$escape_expand(\n\t))
...
PWD_DEST_WIN ~= s,/,\\,g
win32: QMAKE_POST_LINK += $$quote(xcopy $$PWD_WIN\game.dds.config $$PWD_DEST_WIN\sample-racer.config* /y /d$$escape_expand(\n\t))
